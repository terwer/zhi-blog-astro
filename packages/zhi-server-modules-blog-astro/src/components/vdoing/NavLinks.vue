<template>
    <nav class="nav-links" v-if="computes.userLinks.value.length || computes.repoLink.value">
        <!-- user links -->
        <div class="nav-item" v-for="item in computes.userLinks.value" :key="item.link">
