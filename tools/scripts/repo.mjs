...
try {
    ...
    // 拷贝文件
    execSync(`rsync -av --delete --exclude='README_zh_CN.md' --exclude='README.md' --exclude='tools/venv' --exclude='.git' --exclude='tsconfig.base.json' --exclude='packages' --exclude='.github' --exclude-from='.gitignore' . ${toPath}`)
    execSync(`rsync -av --delete --exclude='README_zh_CN.md' --exclude='README.md' --exclude='tools/venv' --exclude='tools' --exclude='.git' --exclude='tsconfig.base.json' ./packages/${name} ${toPath}/packages`)
